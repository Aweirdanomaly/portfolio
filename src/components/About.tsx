	...
	return (
		<>
			<div className="relative flex flex-col items-center min-h-screen px-10 mx-auto mb-40 text-center md:text-left md:flex-row md:flex-wrap max-w-7xl justify-evenly">
				<h3
					id="chunk"
					className="md:w-full md:text-center p-10 top-2 uppercase tracking-[20px] text-ThemeColor text-2xl sm: mb-10 "
				>
					About Me
				</h3>
...
//To implement later. Just uses Next Image tag
...
//                 //   object-top makes it round and moves pic up
//                   className=" lg:w-1/2  relative  mb-20 rounded-full md:mb-5 md:rounded-lg md:h-95 xl:w-[500px] xl:h-[500px] md:mr-4 "
//                   >
//                   <Image src={'/p.png'} fill alt='profile pic' className='object-cover'/>
//                   </motion.div>
